...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentSetFieldEntry'
        db.create_table(u'crowdataapp_documentsetfieldentry', (
    ...
    def backwards(self, orm):
        # Deleting model 'DocumentSetFieldEntry'
        db.delete_table(u'crowdataapp_documentsetfieldentry')
