...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSet.description'
        db.add_column(u'crowdataapp_documentset', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSet.description'
        db.delete_column(u'crowdataapp_documentset', 'description')
