...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSet.created_at'
        db.add_column(u'crowdataapp_documentset', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DocumentSet.updated_at'
        db.add_column(u'crowdataapp_documentset', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSet.created_at'
        db.delete_column(u'crowdataapp_documentset', 'created_at')

        # Deleting field 'DocumentSet.updated_at'
        db.delete_column(u'crowdataapp_documentset', 'updated_at')
