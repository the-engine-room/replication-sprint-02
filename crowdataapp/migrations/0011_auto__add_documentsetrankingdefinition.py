...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'DocumentSetRankingDefinition'
        db.delete_table(u'crowdataapp_documentsetrankingdefinition')
    ...
    models = {
        ...
        u'crowdataapp.documentsetrankingdefinition': {
            ...
            'field': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fields'", 'to': u"orm['crowdataapp.DocumentSetFormField']"}),
