...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentSetRankingDefinition.name'
        db.alter_column(u'crowdataapp_documentsetrankingdefinition', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

    def backwards(self, orm):

        # Changing field 'DocumentSetRankingDefinition.name'
        db.alter_column(u'crowdataapp_documentsetrankingdefinition', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        u'crowdataapp.documentsetrankingdefinition': {
            ...
            'magnitude_field': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'magnitude_fields'", 'to': u"orm['crowdataapp.DocumentSetFormField']"}),
