...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentSetRankingDefinition.magnitude_field'
        db.alter_column(u'crowdataapp_documentsetrankingdefinition', 'magnitude_field_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['crowdataapp.DocumentSetFormField']))

    def backwards(self, orm):

        # Changing field 'DocumentSetRankingDefinition.magnitude_field'
        db.alter_column(u'crowdataapp_documentsetrankingdefinition', 'magnitude_field_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crowdataapp.DocumentSetFormField']))
    ...
    models = {
        ...
        u'crowdataapp.documentsetrankingdefinition': {
            ...
            'document_set': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ranking_documents'", 'to': u"orm['crowdataapp.DocumentSet']"}),
            ...
            'magnitude_field': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'magnitude_fields'", 'null': 'True', 'to': u"orm['crowdataapp.DocumentSetFormField']"}),
