...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding field 'Document.stored_validity_rate'
        db.add_column(u'crowdataapp_document', 'stored_validity_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Document.entries_threshold_override'
        db.delete_column(u'crowdataapp_document', 'entries_threshold_override')
    ...
    models = {
        ...
        u'crowdataapp.document': {
            ...
            'entries_threshold_override': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
