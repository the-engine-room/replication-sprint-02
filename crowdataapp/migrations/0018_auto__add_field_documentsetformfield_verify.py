...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSetFormField.verify'
        db.add_column(u'crowdataapp_documentsetformfield', 'verify',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSetFormField.verify'
        db.delete_column(u'crowdataapp_documentsetformfield', 'verify')
