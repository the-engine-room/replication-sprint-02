...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSetRankingDefinition.sort_order'
        db.add_column(u'crowdataapp_documentsetrankingdefinition', 'sort_order',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSetRankingDefinition.sort_order'
        db.delete_column(u'crowdataapp_documentsetrankingdefinition', 'sort_order')
