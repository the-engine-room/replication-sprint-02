...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSet.published'
        db.add_column(u'crowdataapp_documentset', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSet.published'
        db.delete_column(u'crowdataapp_documentset', 'published')
