...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CanonicalFieldEntryLabel.value'
        db.alter_column(u'crowdataapp_canonicalfieldentrylabel', 'value', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'CanonicalFieldEntryLabel.value'
        db.alter_column(u'crowdataapp_canonicalfieldentrylabel', 'value', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
