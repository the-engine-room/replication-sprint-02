...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crowdataapp_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feedback_text', self.gf('django.db.models.fields.CharField')(max_length=10000)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crowdataapp.Document'])),
        ))
        db.send_create_signal(u'crowdataapp', ['Feedback'])

        # Adding field 'Document.category'
        db.add_column(u'crowdataapp_document', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'Document.updated_at'
        db.add_column(u'crowdataapp_document', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 14, 0, 0), blank=True),
                      keep_default=False)

        # Changing field 'DocumentSetFormField.group'
        db.alter_column(u'crowdataapp_documentsetformfield', 'group', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DocumentSetFormField.help_text'
        db.alter_column(u'crowdataapp_documentsetformfield', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):
        # Deleting model 'Feedback'
        db.delete_table(u'crowdataapp_feedback')

        # Deleting field 'Document.category'
        db.delete_column(u'crowdataapp_document', 'category')

        # Deleting field 'Document.updated_at'
        db.delete_column(u'crowdataapp_document', 'updated_at')

        # Changing field 'DocumentSetFormField.group'
        db.alter_column(u'crowdataapp_documentsetformfield', 'group', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'DocumentSetFormField.help_text'
        db.alter_column(u'crowdataapp_documentsetformfield', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=100))
